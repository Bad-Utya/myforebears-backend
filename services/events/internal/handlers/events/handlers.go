...
type EventsService interface {
	...
	CreateEvent(ctx context.Context, treeID string, eventTypeID string, primaryPersonIDs []string, additionalPersonIDs []string, dateISO string, datePrecision models.EventDatePrecision, dateBound models.EventDateBound, dateUnknown bool, isAutogenerated bool) (models.Event, error)
	GetEvent(ctx context.Context, treeID string, eventID string) (models.Event, error)
	ListEventsByTree(ctx context.Context, treeID string) ([]models.Event, error)
	UpdateEvent(ctx context.Context, treeID string, eventID string, eventTypeID string, primaryPersonIDs []string, additionalPersonIDs []string, dateISO string, datePrecision models.EventDatePrecision, dateBound models.EventDateBound, dateUnknown bool) (models.Event, error)
	DeleteEvent(ctx context.Context, treeID string, eventID string) error
}
...
func (h *Handler) GetEvent(ctx context.Context, req *eventspb.GetEventRequest) (*eventspb.GetEventResponse, error) {
	event, err := h.service.GetEvent(ctx, req.GetTreeId(), req.GetEventId())
	if err != nil {
		return nil, grpcerr.Map(err)
	}
...
func (h *Handler) ListEventsByTree(ctx context.Context, req *eventspb.ListEventsByTreeRequest) (*eventspb.ListEventsByTreeResponse, error) {
	events, err := h.service.ListEventsByTree(ctx, req.GetTreeId())
	if err != nil {
		return nil, grpcerr.Map(err)
	}
...
func (h *Handler) DeleteEvent(ctx context.Context, req *eventspb.DeleteEventRequest) (*eventspb.DeleteEventResponse, error) {
	err := h.service.DeleteEvent(ctx, req.GetTreeId(), req.GetEventId())
	if err != nil {
		return nil, grpcerr.Map(err)
	}
