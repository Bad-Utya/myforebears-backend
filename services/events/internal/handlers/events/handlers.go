...
type EventsService interface {
	...
	CreateEvent(ctx context.Context, requestUserID int, treeID string, eventTypeID string, primaryPersonIDs []string, additionalPersonIDs []string, dateISO string, datePrecision models.EventDatePrecision, dateBound models.EventDateBound, dateUnknown bool, isAutogenerated bool) (models.Event, error)
	...
	UpdateEvent(ctx context.Context, requestUserID int, eventID string, eventTypeID string, primaryPersonIDs []string, additionalPersonIDs []string, dateISO string, datePrecision models.EventDatePrecision, dateBound models.EventDateBound, dateUnknown bool) (models.Event, error)
