...
const (
	...
	EventsService_GetEventType_FullMethodName     = "/events.EventsService/GetEventType"
	EventsService_ListEventTypes_FullMethodName   = "/events.EventsService/ListEventTypes"
	...
	EventsService_GetEvent_FullMethodName         = "/events.EventsService/GetEvent"
	EventsService_ListEventsByTree_FullMethodName = "/events.EventsService/ListEventsByTree"
...
type EventsServiceClient interface {
	...
	ListEventsByTree(ctx context.Context, in *ListEventsByTreeRequest, opts ...grpc.CallOption) (*ListEventsByTreeResponse, error)
...
func (c *eventsServiceClient) GetEventType(ctx context.Context, in *GetEventTypeRequest, opts ...grpc.CallOption) (*GetEventTypeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetEventTypeResponse)
	err := c.cc.Invoke(ctx, EventsService_GetEventType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventsServiceClient) ListEventTypes(ctx context.Context, in *ListEventTypesRequest, opts ...grpc.CallOption) (*ListEventTypesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListEventTypesResponse)
	err := c.cc.Invoke(ctx, EventsService_ListEventTypes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventsServiceClient) ListEventsByTree(ctx context.Context, in *ListEventsByTreeRequest, opts ...grpc.CallOption) (*ListEventsByTreeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListEventsByTreeResponse)
	err := c.cc.Invoke(ctx, EventsService_ListEventsByTree_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventsServiceServer interface {
	...
	ListEventsByTree(context.Context, *ListEventsByTreeRequest) (*ListEventsByTreeResponse, error)
...
func (UnimplementedEventsServiceServer) GetEventType(context.Context, *GetEventTypeRequest) (*GetEventTypeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetEventType not implemented")
}
func (UnimplementedEventsServiceServer) ListEventTypes(context.Context, *ListEventTypesRequest) (*ListEventTypesResponse, error) {
...
func (UnimplementedEventsServiceServer) ListEventsByTree(context.Context, *ListEventsByTreeRequest) (*ListEventsByTreeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListEventsByTree not implemented")
}
...
func _EventsService_GetEventType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetEventTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventsServiceServer).GetEventType(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventsService_GetEventType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServiceServer).GetEventType(ctx, req.(*GetEventTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EventsService_ListEventTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListEventTypesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventsServiceServer).ListEventTypes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventsService_ListEventTypes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServiceServer).ListEventTypes(ctx, req.(*ListEventTypesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EventsService_ListEventsByTree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListEventsByTreeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventsServiceServer).ListEventsByTree(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventsService_ListEventsByTree_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServiceServer).ListEventsByTree(ctx, req.(*ListEventsByTreeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _EventsService_GetEventType_Handler,
		},
		{
			MethodName: "ListEventTypes",
			Handler:    _EventsService_ListEventTypes_Handler,
		},
		{
		...
		{
			MethodName: "ListEventsByTree",
			Handler:    _EventsService_ListEventsByTree_Handler,
		},
		{
