...
const (
	...
	PersonService_AddRelationship_FullMethodName    = "/person.PersonService/AddRelationship"
	PersonService_RemoveRelationship_FullMethodName = "/person.PersonService/RemoveRelationship"
	PersonService_GetRelatives_FullMethodName       = "/person.PersonService/GetRelatives"
	PersonService_GetTree_FullMethodName            = "/person.PersonService/GetTree"
)
...
func (c *personServiceClient) AddRelationship(ctx context.Context, in *AddRelationshipRequest, opts ...grpc.CallOption) (*AddRelationshipResponse, error) {
	...
	err := c.cc.Invoke(ctx, PersonService_AddRelationship_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *personServiceClient) RemoveRelationship(ctx context.Context, in *RemoveRelationshipRequest, opts ...grpc.CallOption) (*RemoveRelationshipResponse, error) {
	...
	err := c.cc.Invoke(ctx, PersonService_RemoveRelationship_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *personServiceClient) GetRelatives(ctx context.Context, in *GetRelativesRequest, opts ...grpc.CallOption) (*GetRelativesResponse, error) {
	...
	err := c.cc.Invoke(ctx, PersonService_GetRelatives_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *personServiceClient) GetTree(ctx context.Context, in *GetTreeRequest, opts ...grpc.CallOption) (*GetTreeResponse, error) {
	...
	err := c.cc.Invoke(ctx, PersonService_GetTree_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPersonServiceServer) AddRelationship(context.Context, *AddRelationshipRequest) (*AddRelationshipResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddRelationship not implemented")
}
func (UnimplementedPersonServiceServer) RemoveRelationship(context.Context, *RemoveRelationshipRequest) (*RemoveRelationshipResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveRelationship not implemented")
}
func (UnimplementedPersonServiceServer) GetRelatives(context.Context, *GetRelativesRequest) (*GetRelativesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRelatives not implemented")
}
func (UnimplementedPersonServiceServer) GetTree(context.Context, *GetTreeRequest) (*GetTreeResponse, error) {
...
func _PersonService_AddRelationship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRelationshipRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PersonServiceServer).AddRelationship(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PersonService_AddRelationship_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).AddRelationship(ctx, req.(*AddRelationshipRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PersonService_RemoveRelationship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveRelationshipRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PersonServiceServer).RemoveRelationship(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PersonService_RemoveRelationship_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).RemoveRelationship(ctx, req.(*RemoveRelationshipRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PersonService_GetRelatives_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRelativesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PersonServiceServer).GetRelatives(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PersonService_GetRelatives_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).GetRelatives(ctx, req.(*GetRelativesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PersonService_GetTree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTreeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PersonServiceServer).GetTree(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PersonService_GetTree_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServiceServer).GetTree(ctx, req.(*GetTreeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PersonService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PersonService_AddRelationship_Handler,
		},
		{
			MethodName: "RemoveRelationship",
			Handler:    _PersonService_RemoveRelationship_Handler,
		},
		{
			MethodName: "GetRelatives",
			Handler:    _PersonService_GetRelatives_Handler,
		},
		{
			MethodName: "GetTree",
			Handler:    _PersonService_GetTree_Handler,
		},
	},
